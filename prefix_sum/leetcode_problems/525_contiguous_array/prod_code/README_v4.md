...
This file checks whether the `Solution` class works correctly.
...
```bash
./build.sh -prod ./path/contiguous_array_v4.cpp
```
...
```text
contiguous_array.hpp                  -> class interface
contiguous_array.cpp                  -> class implementation
contiguous_array_v4.cpp               -> test runner and main function
